// # Third JavaScript Assessment Study Problems
//
// ## Problem 1
//
...
// ## Problem 2
//
// Write a function, ```getOlder```, that takes in an array of dog objects and increases the value of the

// age properties by 1. No return value is needed since the original array of objects will be changed by this function.
//
var dogs = [
    {
        name: "Chompers",
...
console.log(dogs[0].name + " is " + dogs[0].age + ".");
console.log("---");
console.log(dogs[1].name + " is " + dogs[1].age + ".");
console.log("---");
console.log(dogs[2].name + " is " + dogs[2].age + ".");
console.log("---");
